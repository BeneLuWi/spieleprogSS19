...
public class NetworkPlayerReceiver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (buttonPressed == "C" || Input.GetKeyDown(KeyCode.C))
        {
            chatActive = true;
        }
        if (buttonPressed == "Escape" || Input.GetKeyDown(KeyCode.Escape))
        {
            chatActive = false;
        } 
        ...
        if (!chatActive)
        {
            ...
            // Jump to Nextworld
            if (buttonPressed == "Tab" || Input.GetKeyDown(KeyCode.Tab))
            {
            ...
            // Vertical Movement
            if (buttonPressed == "Space" || Input.GetKey(KeyCode.Space))
            {
            ...
            // Horizontal Movement
            if (buttonPressed == "LeftShift" || Input.GetKey(KeyCode.LeftShift))
            {
