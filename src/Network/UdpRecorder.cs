...
public class UdpRecorder : MonoBehaviour
{
    ...
    IEnumerator StreamBytes()
    {
        ...
        byte[] pngBytesSlice = new byte[64000];
        ...
        while (clientConnected)
        {
            ...
            try
            {
                Thread writerThread = new Thread(() =>
                {
                    ...
                    if (pngBytes.Length > 64000)
                    {
                        Array.Copy(pngBytes, pngBytesSlice, 64000);
                        sender.Send(pngBytesSlice, pngBytesSlice.Length, remoteEndPoint);
                    } else
                    {
